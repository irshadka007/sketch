...
export default function Time() {
    return (
        <div>
            <div class="container ">
                <div class=" main">
                    <ul class="card1 uk-animation-slide-bottom cbp_tmtimeline">
                        <li>

                            <div class="cbp_tmicon "></div>
                            <div class="cbp_tmlabel">
                                <h2>2017</h2>
                                <p class="uk-text-justify">Winter purslane courgette pumpkin quandong komatsuna fennel green bean cucumber watercress. Pea sprouts wattle seed rutabaga okra yarrow cress avocado grape radish bush tomato ricebean black-eyed pea maize eggplant. </p>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="cbp_tmlabel">
                                <h2>2018</h2>
                                <p class="uk-text-justify">Caulie dandelion maize lentil collard greens radish arugula sweet pepper water spinach kombu courgette lettuce. Celery coriander bitterleaf epazote radicchio shallot winter purslane collard greens spring onion squash lentil. Artichoke salad bamboo shoot black-eyed pea brussels sprout garlic kohlrabi.</p>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <div class="cbp_tmlabel">
                                <h2>2021</h2>
                                <p class="uk-text-justify">Parsley amaranth tigernut silver beet maize fennel spinach. Ricebean black-eyed pea maize scallion green bean spinach cabbage jícama bell pepper carrot onion corn plantain garbanzo. Sierra leone bologi komatsuna celery peanut swiss chard silver beet squash dandelion maize chicory burdock tatsoi dulse radish wakame beetroot.</p>
                            </div>
                        </li>
