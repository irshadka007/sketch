        ...
        <div  >
            ...
            <div id="modal-full" class=" uk-modal-full" uk-modal="true" style={{ backgroundColor: "white", height: "100vh" }} >
                ...
                <div class="uk-visible@m uk-modal-dialog" style={{ backgroundColor: "white", height: "100%" }}>
                        ...
                        <div class="uk-width-1-3">
                            ...
                            <div style={{ backgroundColor: "#C45515", color: "black", width: "55", marginTop: "16%", marginLeft: "10%" }} class="uk-card uk-card-default">
                                <div class="uk-card-media-top">
                                    <img style={{ width: "100%" }} src="https://image.shutterstock.com/image-vector/orange-yellow-waves-background-banner-260nw-1417431590.jpg" uk-img="true" alt="" />
                                </div>
                    ...
                    <div style={{ backgroundColor: "#DB7D1A", width: "100vw", height: "25%", marginTop: "-22%" }}>
                        <div class="uk-card" style={{ paddingLeft: "15px", height: "100%", width: "30%", backgroundColor: "#B84A14", marginLeft: "31.2%", overflowY: "auto", color: "white" }}><h4 style={{ marginLeft: "7%", marginTop: "7px", color: "white" }}>Solutions</h4>
                            <ul style={{ listStyleType: "none", marginTop: "-5px", fontWeight: "lighter" }}><li>Technical Assistance</li><li>Security</li><li>Software Development</li></ul></div>
                    </div>
